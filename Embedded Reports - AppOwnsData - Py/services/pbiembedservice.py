...
class PbiEmbedService:
    ...
    def get_embed_params_for_single_report(self, workspace_id, report_id, additional_dataset_id=None, username=None, roles=None):
        ...
        embed_token = self.get_embed_token_for_single_report_single_workspace(
            ...
            username=username, roles=roles  # pass RLS through
        )
    ...
    def get_embed_token_for_single_report_single_workspace(self, report_id, dataset_ids, target_workspace_id=None, username=None, roles=None):
        ...
        if username is not None and roles is not None:
            ...
            request_body.__dict__['identities'] = [
                {
                    'username': username,
                    'roles': roles,
                    'datasets': [dataset_id]
